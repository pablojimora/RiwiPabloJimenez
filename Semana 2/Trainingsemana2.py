print("Bienvenido a su calculadora de calificaciones, recuerde que serás aprobado")
print("si tu calificacionn está entre 70 y 100, de lo contrario será reprobado")
...
for nota in notas:
    if nota >=70:
        ...
        print("Reprobado")
print(f"la suma es de {sumar} dividido por {len(notas)} notas ingresadas, su promedio es:")
promedio=sumar/len(notas)
